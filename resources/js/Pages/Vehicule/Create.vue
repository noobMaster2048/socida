            ...
            <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        ...
                        <h4 class="mg-b-0 tx-spacing--1">Bienvenue sur le formulaire d'enregistrement d'un véhicule</h4>
                    </div>
                </div>
                        ...
                        <form @submit.prevent="submit" novalidate>
                            <fieldset class="form-group row">
                               ...
                               <b-card>
                                   ...
                                   <div class="form-group row">
                                       <label for="ordre" class="col-sm-2 col-form-label">Ordre <span class="tx-danger">*</span></label>
                                       <div class="col-sm-10">
                                           <input id="ordre" type="text" v-model="form.ordre" class="form-control">
                                           <small v-if="$page.errors.ordre" class="text-danger">
                                               {{$page.errors.ordre[0]}}
                                           </small>
                                       </div>
                                   </div>
                                   <div class="form-group row">
                                       <label for="marques" class="col-sm-2 col-form-label">Marque <span class="tx-danger">*</span></label>
                                       <div class="col-sm-10">
                                           <select id="marques" v-model="form.marque_id" class="form-control">
                                   ...
                                   <div class="form-group row">
                                       <label for="categories" class="col-sm-2 col-form-label">Categorie <span class="tx-danger">*</span></label>
                                       <div class="col-sm-10">
                                           <select  id="categories" v-model="form.categorie_id" class="form-control">
                                               <option :value="null"></option>
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    ...
                    cap_coffre: null,
                    ray_braq: null,
                    lien_visuel_ext: null,
                    lien_visuel_int: null,
                    img_path: null,
                },
                imageList: [],
                dialogImgUrl: '',
        ...
        methods: {
            submit() {
                ...
                this.$inertia.post(this.route('vehicule.store'), formData, {headers: {'Content-Type': 'multipart/form-data'}}).then(() =>  this.sending = false);
            },
