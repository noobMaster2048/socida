            ...
            <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        ...
                        <h4 class="mg-b-0 tx-spacing--1">Bienvenue sur la création d'un modèle de véhicule</h4>
                    </div>
                </div>
...
export default {
    metaInfo: {title: 'Formulaire Modèle'},
    ...
    methods: {
        submit() {
            this.sending = true;
            this.$inertia.post(this.route('categorie.store'), this.form)
