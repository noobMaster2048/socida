                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                                <li class="breadcrumb-item"><inertia-link :href="route('marques')">Liste des marques</inertia-link></li>
                                <li class="breadcrumb-item active" aria-current="page">Formulaire marque</li>
                            </ol>
                        </nav>
                        <h4 class="mg-b-0 tx-spacing--1">Bienvenue sur la modification d'une marque de véhicule</h4>
                    </div>
                </div>
                    ...
                    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                        <form @submit.prevent="submit" novalidate>
                            ...
                            <div class="d-none mg-sm-l-10 mg-sm-t-25 pd-t-4 d-flex align-items-center justify-content-center">
                                ...
                                <div class="pd-10">
                                    <inertia-link class="btn btn-secondary" :href="route('marques')"><i class="fas fa-reply"></i> Annuler</inertia-link>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    export default {
        metaInfo: {title: 'Formulaire Marque'},
        ...
        methods: {
            submit() {
                this.sending = true;
                this.$inertia.put(this.route('marque.update', this.marque.id), this.form)
